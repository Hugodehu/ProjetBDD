...
namespace NS_BDDservice
{
    ...
    public:
        ...
        void effacer_article(System::String^, System::String^, System::String^);
        System::Data::DataSet^ Afficher_article(System::String^ ,System::String^, System::String^);
    };
    ...
    public:
        service_Commande();
        void Ajouter_commande(System::String^ , System::String^ , System::String^ ,System::String^ Nom, System::String^ Quantité, System::String^ Couleur, System::String^ tva, System::String^ remise, System::String^ moyen_paiement, System::String^ Nbr_paiement, System::String^ Date_prem_paiment, System::String^ Date_paiement);
    ...
    ref class service_Stat
    {
    private:
        NS_load::CLload^ oCad;
        NS_BDD::statistique^ oStats;
    public:
        service_Stat();

        System::Data::DataSet^ panier_moy(void);
        System::Data::DataSet^ chiffre_affaire(System::String^);
        System::Data::DataSet^ seuil_appro(void);
        System::Data::DataSet^ montant_total_achat(System::String^,System::String^,System::String^);
        System::Data::DataSet^ arcticle_plus_vendu(void);
        System::Data::DataSet^ article_moins_vendu(void);
        System::Data::DataSet^ val_com_stock(void);
        System::Data::DataSet^ val_achat_stock(void);
        System::Data::DataSet^ simulation(System::String^, System::String^,System::String^, System::String^);
    };
}

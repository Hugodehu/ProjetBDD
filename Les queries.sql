...
WHERE(Adresse.id_adresse = Personnel.id_adresse AND Personnel.id_personnel = 2 AND Personnel.nom = 'Shockley' AND prenom = 'Kay');
	vérifié
...
INNER JOIN Ville ON Ville.id_ville = Adresse.id_ville
WHERE Adresse.id_adresse = Personnel.id_adresse AND Personnel.id_personnel = 2 AND Personnel.nom = 'DR. XXXXXX' AND prenom = 'douze' AND Ville.nom = 'Shamokin' AND Ville.code_postal = '78705'
...
WHERE Authentification.id_authentification = Personnel.id_authentification AND Personnel.id_personnel = 2 AND Personnel.nom = 'DR. XXXXXX' AND prenom = 'douze'
	vérifié
